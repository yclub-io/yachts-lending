      ...
      <p className="lg:mb-[125px] mb-[68px] flex justify-center text-center font-Plus lg:text-5xl text-[26px] font-extrabold">
        ...
        <div className="flex lg:flex-row flex-col items-center lg:gap-[15px] gap-y-[45px]">
          ...
          {/*member 1*/}
            ...
            <div className="relative flex w-[285px] border border-black-1 rounded-[20px] basis-1/5 flex-col font-Grotesk text-center h-[355px] px-1"> 
                <p className="z-10 font-bold text-[28px] pt-[50px]"> 
                  Neptune
                </p>
                    <p className="z-10 text-sm text-gray-1 pt-[25px]"> 
                      Founder
                    </p>
                      
                      <img
                        className=" z-10 w-8 mx-auto py-[20px]"
                        src="/images/teamSectionInfDivider.svg"
                        alt="divider"
                      ></img>
                    
                        <p className=" z-10 w-[245px] mx-auto text-base text-gray-1 leading-[20px] pb-[60px]"> 
                        ...
                        <div className="absolute lg:left-[-5px] left-[10px] top-[0px] w-[400px]">
                    <img
                         className="w-[260px]"
                         src="/images/teamSectionBorder.svg"
                         alt="border"
                    />  
                  </div>
            </div>
                  ...
                  Poseidon
                    ...
                    <p className="z-10 text-sm text-gray-1 pt-[25px]"> 
                      ...
                      ></img>
                        ...
                        <p className="z-10 w-[245px] mx-auto text-base text-gray-1 leading-[20px] lg:pb-0 pb-[60px]"> 
