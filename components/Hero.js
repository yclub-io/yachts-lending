...
const Hero = () => {
  return (
    <>
      ...
      <button
       className="lg:w-auto w-[342px]  absolute z-40 text-white-1 border border-pink-1 bg-black-1 shadow-btnGlowInit py-3 px-12 rounded-full font-Grotesk text-base 
